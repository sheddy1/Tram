...
<div class="header2">
    <span class="header2_links">
        <img src="{{ asset('images/menu.png') }}" alt="search" class="header2_search_btn1">
    ...
    <span class="header2_search_button">
        <span class="search">
            ...
            <label for="header2_check">
                <img src="{{ asset('images/search.png') }}" alt="search" class="header2_search_btn">
                <img src="{{ asset('images/close_green.png') }}" alt="search" class="header2_search_btn2">
            </label>
        </span>
