        ...
        <span class="newssection_extra">
            <span class="newssection_extra_box">
                <span class="newssection_extra_box1">
                    <span class="newssection_extra_box1_header">
                    ...
                    <span class="newssection_extra_box1_main">
                        <text class="newssection_extra_box1_main_txt">
                            Poverty Would be Gone Says Tinubu
                        </text>
                    </span>

                    <span class="newssection_extra_box1_footer">
                        <img src="{{ asset('images/images/article9_person.png') }}" alt="search" class="section6_span_info_footer_image">
                        <text class="newssection_extra_box1_footer_txt">Nelson Igwele</text>
                        <text class="newssection_extra_box1_footer_txt">Dec. 23, 2024</text>
                    </span>
                </span>

                <span class="newssection_extra_box2">
                    <img src="{{ asset('images/images/cover.png') }}" alt="calender" class="newssection_extra_box2_cover">
                    <img src="{{ asset('images/images/article8.png') }}" alt="calender" class="newssection_extra_box2_image">
                </span>
            </span>
