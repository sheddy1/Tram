...
<div class="section2">
    ...
    <span class="articles">
        <div class="article1" style="background: url('{{ asset('images/images/article1.png') }}')">
            <button class="article1_button">
                Culture
            </button class="article1_text">

            <text class="article_text">
                The History of the Fulani People
            </text>
            ...
            <img src="asset('images/images/article1.png')" alt="">
        </div>
