...
<div class="header2">
    <span class="header2_links">
        <table class="header2_links_table">
            <tr>
                <td class="header2_links_table_main_td td_home_header_general">Home</td>
                <td class="td_home_header_general">Videos</td>
                <td class="td_home_header_general">News</td>
                <td class="td_home_header_general">About Us</td>
                <td class="td_home_header_general">Contact Us </td>
            </tr>
        </table>
    </span>
    <span class="header2_search_button"></span>
</div>
